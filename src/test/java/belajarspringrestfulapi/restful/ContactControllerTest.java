package belajarspringrestfulapi.restful;
...
import belajarspringrestfulapi.restful.model.UpdateContactRequest;
...
public class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception {
        CreateContactRequest request = new CreateContactRequest();
        request.setFirstName("Sandy");
        request.setLastName("Dwi");
        request.setEmail("sandy@example.com");
        ...
        mockMvc.perform(
            ...
            assertEquals("Sandy", response.getData().getFirstName());
            assertEquals("Dwi", response.getData().getLastName());
            assertEquals("sandy@example.com", response.getData().getEmail());
    ...
    void getContactSuccess() throws Exception {
        ...
        contact.setFirstName("Sandy");
        contact.setLastName("Dwi");
        contact.setEmail("sandy@example.com");
    ...
    void updateContactSuccess() throws Exception {
        ...
        CreateContactRequest request = new CreateContactRequest();
        request.setFirstName("Ainur");
        request.setLastName("Tri");
        request.setEmail("ainur@example.com");
